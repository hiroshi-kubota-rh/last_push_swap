...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/11/11 23:38:56 by khiroshi          #+#    #+#             */
/*   Updated: 2022/11/12 00:01:24 by khiroshi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			flash_all_struct(t_node *stack_a, \
		t_node *stack_b, t_info *info);
bool			check_sorted(t_node *stack);
